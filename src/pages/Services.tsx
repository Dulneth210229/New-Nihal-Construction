...
export default function ServicesPage() {
  usePageMeta({
    ...
    description: "Explore Nihal Construction's services: building construction, civil engineering, commercial development, renovation & remodeling, residential construction, structural engineering and interior design.",
  });
